  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ── CTA ──────────────────────────────────── */}
        <section className="px-6 md:px-20 mb-32 pt-20">
      ...
      {/* ── Footer ───────────────────────────────────── */}
      <footer className="w-full rounded-t-xl bg-surface-container border-t border-stone-400/10">
        <div className="flex flex-col items-center justify-center gap-10 px-8 py-20 max-w-6xl mx-auto">
          ...
          <div className="flex gap-6 items-center">
            ...
            <a href="https://github.com/Arnab-Afk/hedera" target="_blank" rel="noopener noreferrer"
              className="text-stone-400 hover:text-green-800 transition-colors duration-200"
              aria-label="GitHub"
            >
